...
@RestController // Informar que a class é um recurso web implementado por um controlador REST -
				// é um conttroler
...
public class UserResource {
	...
	@DeleteMapping(value = "/{id}") // indica que a url vai ter um parametro
	public ResponseEntity<Void> delete(@PathVariable Long id) {
		service.delete(id);
		return ResponseEntity.noContent().build();
		// retorna sem corpo de resposta e codigo html 204
	}
